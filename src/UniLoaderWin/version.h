...
//
// Four places show it â€” the title bar, Help > About, `--version`, and the
// VERSIONINFO block Explorer reads â€” and the resource compiler preprocesses, so
...
// comes off the mod page â€” three numbers in one program is two too many to put
...
#define UL_APP_VERSION_STR "1.0.4"
#define UL_APP_VERSION_WSTR L"1.0.4"
